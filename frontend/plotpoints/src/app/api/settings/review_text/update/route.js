...
//   const review_id = params_content.id;
  ...
  const response = await fetch(`${process.env.API_URL}/settings/review_text?review_text_setting=${encodeURIComponent(review_text_setting)}&jwt_token=${encodeURIComponent(jwt_token)}`, {
    method: 'PUT',
    headers: {
